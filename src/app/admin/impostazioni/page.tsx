            ...
            {googleStatus.connected ? (
              ...
              <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
                ...
                <a
                  ...
                  className="mt-4 inline-flex items-center gap-2 rounded-xl bg-text-primary px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-text-primary/90"
                >
